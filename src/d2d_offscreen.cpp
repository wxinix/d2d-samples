...
void create_main_buffer(void)
{
  g_pRT->CreateBitmap(D2D1::SizeU(KEPERNYO_WIDTH, KEPERNYO_HEIGHT),
                      D2D1::BitmapProperties(D2D1::PixelFormat(DXGI_FORMAT_R8G8B8A8_UNORM,
...
void swap_main_buffer(void)
{
  ...
  g_pRT->BeginDraw();
  g_pRT->DrawBitmap(memkeptarolo,
                    D2D1::RectF(0.0f, 0.0f, KEPERNYO_WIDTH - 1, KEPERNYO_HEIGHT - 1),
                    1.0f,
