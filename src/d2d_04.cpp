...
LRESULT CALLBACK WndProc0(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
  ...
  switch (message) {
    ...
    case WM_PAINT:
      ...
      return 0;
    //*********************************
    //Closing the window, releasing resources
    //*********************************
    case WM_CLOSE:
      g_pRT->Release();
